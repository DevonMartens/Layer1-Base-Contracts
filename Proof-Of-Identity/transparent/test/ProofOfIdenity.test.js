...
describe("Proof of Identity Contract", function () {
  ...
  describe("Testing the Proof of Identity Contract initial values upon deployment.", function () {
    it("Proof of Identity Contract: admin should be deployer", async () => {
    //  const transparentUpgradeableProxyArtifact = await hre.artifacts.readArtifact("TransparentUpgradeableProxy");
