...
contract NativeStaking is 
    ...
    */
    ...
    // Error to inform the caller that the sender has no amount to withdraw.
    ...
    */
    function stake(uint256 _amountToken) external payable {
    ...
    */
    function withdraw(uint256 _amountToken, uint256 _amountH1) external  {
        _updateReward(msg.sender);
    ...
    */
    ...
    /**
    * @notice `_authorizeUpgrade` this function is overriden to ensure only the admin can upgrade the contract
